...
List of 9
 ...
 $ defaultIVs  :List of 2c(1:730,27,list of 9)
str(Pikachu)
...
```{r ans32}
Pikachu_stats <- c(as.numeric(Pikachu$baseStats[c(1,2,3)]))
print(Pikachu_stats)
```
...
### 3.4 魔王題——考驗自己有沒有成為程式設計大師/洛托姆的時候到了peciesId): mimikyu
...
baseStats=list(
  ...
  def=96,
  hp=111),
types=list(c("ghost","fairy")),
fastMoves=list(c("FEINT_ATTACK","POUND")),
chargedMoves=list(c("BODY_SLAM","DAZZLING_GLEAM","DISARMING_VOICE","GYRO_BALL")),
legacyMoves=list(c("BODY_SLAM","PLAY_ROUGH")),
 defaultIVs=list(
   cp1500=c(40,15,15,15),
   cp2500=c(40,15,15,15)
 ))

str(Gamemaster[["pokemon"]][[731]])
```
