...
```{r}
taiwan_times <-ymd_hms("2019-04-12 12:55:30",tz="Asia/Taipei") 
oslo_times <- ymd_hms("2018-11-18 15:33:02",tz="Europe/Oslo")
two_times <- c(taiwan_times,oslo_times)
two_times
```
...
accidents <-
'[
{"time":"103-01-01","bureaus":"板橋分局","type":"駕駛人過失-其他","casualties":"1"},
{"time":"103-01-01","bureaus":"海山分局","type":"駕駛人過失-搶越行人穿越道","casualties":"1"}
]'


(my.df <- fromJSON(accidents))
...
accidents <- 
  list(
    list(`time`="2014-01-01",format="%y-%m-%d"),
    `bureaus`=list(
      "板橋分局",
      type="駕駛人過失-其他",
      casualties=1),
...
```{r}
levels(fiveReceipts)
level_fiveReceipts <- fiveReceipts
print(level_fiveReceipts)
