...
```
  ...
  * readline()在Rmd裡只有當它單獨執行時才能正常運作，因為readline是個即時互動
  （interactive）函數，Rmd不是個即時互動環境。
...
將convert_TaiwanDate2WesternDate的body有關套件檢查的部份改成你設計的check_package/check_packages。
